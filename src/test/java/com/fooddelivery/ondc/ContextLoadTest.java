...
class ContextLoadTest {
    ...
    // registryLookupService caches through this; Redis auto-configuration is excluded in this profile.
    @org.springframework.boot.test.mock.mockito.MockBean
    private org.springframework.data.redis.core.RedisTemplate<String, Object> redisTemplate;

    // SecurityContextFilter is @Profile("!contract-test") -- deliberately absent from this profile,
    // which exists for narrow contract tests that never wire security. OndcSecurityConfig requires
    // it, so a full context needs it supplied.
    @org.springframework.boot.test.mock.mockito.MockBean
